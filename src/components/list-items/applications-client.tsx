    ...
    <>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Manage and monitor service principals and enterprise app configurations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <MetricCard title="Total Apps" value={dashboard?.totalApps} icon={<AppWindow className="w-5 h-5" style={{ color: "#f59e0b" }} />} accentColor="amber" />
        <MetricCard title="Active" value={dashboard?.activeCount} icon={<CheckCircle2 className="w-5 h-5" style={{ color: "#10b981" }} />} accentColor="teal" />
        <MetricCard title="Warning" value={dashboard?.warningCount} icon={<AlertTriangle className="w-5 h-5" style={{ color: "#f59e0b" }} />} accentColor="amber" />
        <MetricCard title="Expired/Critical" value={dashboard?.expiredCount} icon={<XCircle className="w-5 h-5" style={{ color: "#ef4444" }} />} accentColor="blue" />
      </div>
